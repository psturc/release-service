...
require (
	...
	github.com/konflux-ci/coverport/instrumentation/go v0.0.0-20251127091220-5d4351a5b6e0
	github.com/konflux-ci/integration-service v0.0.0-20251203094019-fca805f5ce21
